...
@media (min-width: 1200px) and (max-width: 1500px) {
  ...
  html[lang="en"] .cover-slide .hero-lines {
    font-size: 12px;
    line-height: 1.24;
  }

  html[lang="en"] .section-slide {
    gap: 8px;
  }
  ...
  html[lang="en"] .section-slide .section-topic-list span {
    font-size: 6px;
    line-height: 0.78;
    letter-spacing: 0;
  }
  ...
  html[lang^="zh"] .section-slide {
    gap: 2px;
    padding-top: 8px;
    padding-bottom: 8px;
  }

  html[lang^="zh"] .section-slide h2 {
    font-size: clamp(28px, 3.4vw, 48px);
    line-height: 0.94;
  }

  html[lang^="zh"] .section-slide .section-topic-list div {
    min-height: 28px;
    padding: 1px;
  }
  ...
  html[lang^="zh"] .section-slide .section-topic-list span {
    font-size: 6px;
    line-height: 0.78;
    letter-spacing: 0;
  }

  html[lang^="zh"] .watch-slide {
    gap: 12px;
  }

  html[lang^="zh"] .watch-slide .watch-grid {
    gap: 5px;
  }
