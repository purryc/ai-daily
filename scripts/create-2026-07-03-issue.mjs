...
const visuals = {
  cloudflare: visual("cloudflare-agent-crawler-controls-2026-07-03", "Cloudflare AI traffic controls", "official · global · developer surface", [
  ...
  acti: visual("acti-agentic-keyboard-2026-07-03", "Acti agentic keyboard", "wild · official · community", [
  ...
  memomind: visual("memomind-one-friction-2026-07-03", "MemoMind One glasses friction", "reviews · community · crowdfunding signal", [
  ...
  anthropic: visual("claude-sonnet-5-agent-surface-2026-07-03", "Claude Sonnet 5 agent surface", "developer surface · official · global", [
  ...
  cursor: visual("cursor-mobile-agent-control-2026-07-03", "Cursor web and mobile agents", "global · developer surface", [
  ...
  zcode: visual("zai-zcode-glm-coding-harness-2026-07-03", "Z.ai ZCode and GLM coding plan", "china · global · developer surface", [
  ...
  chinaScan: visual("china-ai-glasses-os-scan-2026-07-03", "China AI glasses OS scan", "china · source-lane scan", [
  ...
  researchPatent: visual("wearable-agent-research-patent-watch-2026-07-03", "Wearable agent research and patent watch", "research · patent · weak/unverified", [
...
const topics = [
  ...
  topic({
    ...
    sourceDate: "2026-06-29 to 2026-07-03 scan",
    evidenceLabel: "review/community friction",
  ...
  topic({
    ...
    sourceDate: "2026-07-02 to 2026-07-03 scan",
    evidenceLabel: "developer surface",
...
const issue = {
  ...
  zhTitle: "AI Daily 2026-07-03：Agent 开始争夺入口、权限和眼前屏幕",
  enTitle: "AI Daily 2026-07-03: Agents Fight for Entry Points, Permissions, and Screens in Front of Your Eyes",
