...
const visuals = {
  cloudflare: visual("cloudflare-agent-crawler-controls-2026-07-06", "Cloudflare AI traffic controls", "official · global · developer surface", [
  ...
  acti: visual("acti-agentic-keyboard-2026-07-06", "Acti agentic keyboard", "wild · official · community", [
  ...
  memomind: visual("memomind-one-friction-2026-07-06", "MemoMind One glasses friction", "reviews · community · crowdfunding signal", [
  ...
  anthropic: visual("claude-sonnet-5-agent-surface-2026-07-06", "Claude Sonnet 5 agent surface", "developer surface · official · global", [
  ...
  cursor: visual("cursor-mobile-agent-control-2026-07-06", "Cursor web and mobile agents", "global · developer surface", [
  ...
  zcode: visual("zai-zcode-glm-coding-harness-2026-07-06", "Z.ai ZCode and GLM coding plan", "china · global · developer surface", [
  ...
  chinaScan: visual("china-ai-glasses-os-scan-2026-07-06", "China AI glasses OS scan", "china · source-lane scan", [
  ...
  researchPatent: visual("wearable-agent-research-patent-watch-2026-07-06", "Wearable agent research and patent watch", "research · patent · weak/unverified", [
...
const topics = [
  ...
  topic({
    ...
    sourceDate: "2026-06-29 to 2026-07-06 scan",
    evidenceLabel: "review/community friction",
  ...
  topic({
    ...
    sourceDate: "2026-07-02 to 2026-07-06 scan",
    evidenceLabel: "developer surface",
...
const issue = {
  ...
  zhTitle: "AI Daily 2026-07-06：周末后 Agent 入口战进入基础设施层",
  enTitle: "AI Daily 2026-07-06: After the Weekend, Agent Entry Points Become Infrastructure",
  ...
  coverStory: {
    ...
    zhSummary: [
      "周末后的主线不是模型，而是入口：crawler、键盘、开发者 IDE、眼镜显示和 AIOS。",
      "Cloudflare 把 agent 访问从训练抓取里拆出来，迫使 AI 产品解释自己在替用户做什么。",
      "Acti、Cursor、ZCode 和 MemoMind One 显示 agent 正在进入键盘、手机、桌面和眼前屏幕。"
    ],
    enSummary: [
      "The post-weekend main line is entry point, not model size: crawlers, keyboards, developer IDEs, eyewear displays, and AIOS.",
